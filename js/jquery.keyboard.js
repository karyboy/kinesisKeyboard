...
*/
;(function($){
$.keyboard = function(el, options,callback){
	var base = this, o;
	...
	base.reveal = function(){
		...
		// return base to allow chaining in typing extension
               // mapButtons($('.ui-keyboard-keyset-default > .ui-keyboard-button'));
                bridge.start(); 
		return base;
	};
	...
	base.startup = function(){ 
		...
		base.$allKeys
			...
			.bind('mouseenter.keyboard mouseleave.keyboard', function(e){        //Kary - Hover 
